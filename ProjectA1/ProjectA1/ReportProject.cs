...
namespace ProjectA1
{
    public partial class ReportProject : Form
    {
        ...
        private void bindgrid()
        {
            ...
            string query1 = "Select GroupProject.ProjectId as ProjectId , ProjectAdvisor.AdvisorRole, GroupStudent.StudentId from(GroupStudent join (GroupProject join ProjectAdvisor on GroupProject.ProjectId = ProjectAdvisor.ProjectId)on GroupStudent.GroupId= GroupProject.GroupId )";
            //string query = "select "
            //string query2 = "Select AdvisorId, AdvisorRole from ProjectAdvisor  ";
            //string query3 = "Select Id as StudentId, RegistrationNo from Student";
            ...
            try
            {
                ...
                //daa.SelectCommand = cmd2;
                //SqlDataAdapter daaa = new SqlDataAdapter();
                //daaa.SelectCommand = cmd3;
        ...
        {
            exportgridtopdf(dataGridView1, "Report-1");
        }
    }
}
